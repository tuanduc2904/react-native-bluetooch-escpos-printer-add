# react-native-bluetooch-escpos-printer-add

React-Native plugin for the bluetooth ESC/POS & TSC printers.

## Additional
- Add writeToPrinter function site to Android
...
```javascript
    import {BluetoothManager, BluetoothEscposPrinter, BluetoothTscPrinter} from 'react-native-bluetooth-escpos-printer-add';
```
...
await  BluetoothEscposPrinter.printText("PrintTest\n\r",{});
